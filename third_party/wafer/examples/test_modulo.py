...
def test_wrap_stacked(device):
    ...
    @triton.jit
    def wrap_stacked(a_ptr, c_ptr, M, N, stride_am, stride_an, stride_cm, stride_cn, BLOCK_SIZE_K: tl.constexpr):
...
def test_1d(device):
    ...
    @triton.jit
    def mod_1d(a_ptr, c_ptr, M, N, stride_am, stride_an, stride_cm, stride_cn, BLOCK_SIZE_K: tl.constexpr):
        row = 7
    ...
    expected_out = torch.tensor(
        [[62, 63, 56, 57, 88888, 88888, 88888, 88888], [88888, 88888, 88888, 88888, 88888, 88888, 88888, 88888],
...
def test_2d(device):
    ...
    @triton.jit
    def mod_2d(a_ptr, c_ptr, M, N, stride_am, stride_an, stride_cm, stride_cn, BLOCK_SIZE_K: tl.constexpr):
    ...
    # Expected output copied from running triton on NVDIA gpu
    expected_out = torch.tensor(
        [[22, 23, 16, 17, 88888, 88888, 88888, 88888], [30, 31, 24, 25, 88888, 88888, 88888, 88888],
         [38, 39, 32, 33, 88888, 88888, 88888, 88888], [46, 47, 40, 41, 88888, 88888, 88888, 88888],
         [88888, 88888, 88888, 88888, 88888, 88888, 88888, 88888],
         [88888, 88888, 88888, 88888, 88888, 88888, 88888, 88888],
         [88888, 88888, 88888, 88888, 88888, 88888, 88888, 88888],
         [88888, 88888, 88888, 88888, 88888, 88888, 88888, 88888]], device="cpu")
...
def test_side_by_side_masked_loop(device):
    ...
    @triton.jit
    def wrap_side_by_side_masked_loop(a_ptr, c_ptr, M, N, stride_am, stride_an, stride_cm, stride_cn,
    ...
    # Expected output copied from running triton on NVDIA gpu
    expected_out = torch.tensor(
        [[22, 23, 16, 17, 54, 55, 48, 49], [30, 31, 24, 25, 62, 63, 56, 57], [-99, -99, -99, -99, -99, -99, -99, -99],
         [-99, -99, -99, -99, -99, -99, -99, -99], [88888, 88888, 88888, 88888, 88888, 88888, 88888, 88888],
         [88888, 88888, 88888, 88888, 88888, 88888, 88888, 88888],
         [88888, 88888, 88888, 88888, 88888, 88888, 88888, 88888],
         [88888, 88888, 88888, 88888, 88888, 88888, 88888, 88888],
         [88888, 88888, 88888, 88888, 88888, 88888, 88888, 88888],
...
def test_stacked_masked_loop(device):
    ...
    @triton.jit
    def wrap_stacked_masked_loop(a_ptr, c_ptr, M, N, stride_am, stride_an, stride_cm, stride_cn,
                                 BLOCK_SIZE_K: tl.constexpr):
...
def test_torch_inductor_pattern():
    ...
    expected_out = torch.tensor(
        [[
            0, 128, 256, 384, 1, 129, 257, 385, 2, 130, 258, 386, 3, 131, 259, 387, 4, 132, 260, 388, 5, 133, 261, 389,
            6, 134, 262, 390, 7, 135, 263, 391, 8, 136, 264, 392, 9, 137, 265, 393, 10, 138, 266, 394, 11, 139, 267,
            395, 12, 140, 268, 396, 13, 141, 269, 397, 14, 142, 270, 398, 15, 143, 271, 399
        ],
         [
             16, 144, 272, 400, 17, 145, 273, 401, 18, 146, 274, 402, 19, 147, 275, 403, 20, 148, 276, 404, 21, 149,
             277, 405, 22, 150, 278, 406, 23, 151, 279, 407, 24, 152, 280, 408, 25, 153, 281, 409, 26, 154, 282, 410,
             27, 155, 283, 411, 28, 156, 284, 412, 29, 157, 285, 413, 30, 158, 286, 414, 31, 159, 287, 415
         ],
         [
