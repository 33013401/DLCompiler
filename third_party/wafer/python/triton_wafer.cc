...
void init_triton_wafer_passes_convert(py::module &&m) {
...
void init_triton_wafer_common(py::module &&m) {
...
void init_triton_wafer(py::module &&m) {
  init_triton_wafer_common(m.def_submodule("common"));
  auto passes = m.def_submodule("passes");
  init_triton_wafer_passes_convert(passes.def_submodule("convert"));
