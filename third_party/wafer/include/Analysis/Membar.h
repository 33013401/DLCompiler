#ifndef WAFER_MEMBAR_H
#define WAFER_MEMBAR_H
...
/// Membar-like analysis for Wafer IR using `mlir::triton::alloc::Allocation`.
/// Inserts `wafer::BarrierOp` as needed.
