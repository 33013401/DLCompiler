...
- docker 5.5.0: hub.wafer.com/tx8/ubuntu/v5.5.0.1030:wafer_release
...
- docker 5.6.0daily: hub.wafer.com/tx8/ubuntu/daily:wafer_release_patch.251219130722
...
bash ./scripts/run_wafer.sh pytest ./flaggems_tests/test_unary_pointwise_ops.py::test_accuracy_abs --ref cpu --mode quick
```
