...
./third_party/wafer/scripts/tools/offline_python_deps.sh -i -r third_party/wafer/scripts/requirements_ts.txt -d ../offline_pkgs/
./third_party/wafer/scripts/tools/offline_python_deps.sh -i -r python/requirements.txt -d ../offline_pkgs/
apt install lld
```
...
- 下载http://gitlab.wafer.com/tx8_toolchain/torch_txda
- python setup.py bdist_wheel
- 安装whl

## 安装triton

- ./third_party/wafer/scripts/build_wafer.sh

## 运行

- ./third_party/wafer/scripts/run_wafer.sh python third_party/wafer/examples/profile_matmul.py
- ./third_party/wafer/scripts/run_wafer.sh pytest ../flaggems/tests/test_unary_pointwise_ops.py::test_accuracy_abs --ref cpu
...
./third_party/wafer/scripts/run_wafer.sh python xxxxxx
```
