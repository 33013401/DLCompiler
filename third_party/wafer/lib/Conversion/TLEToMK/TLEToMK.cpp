...
struct DsaLocalLoadToMemrefPattern : public OpRewritePattern<triton::LoadOp> {
  ...
  LogicalResult matchAndRewrite(triton::LoadOp loadOp,
    ...
    auto toTensor = rewriter.create<bufferization::ToTensorOp>(
      loadOp.getLoc(), resultTy, localPtrOp.getSrc(),
...
void mlir::triton::populateTLEToMKConversionPatterns(
  ...
  patterns.add<DsaRandGenToMkPattern, DsaBitcastToMkPattern, DsaExtractSliceToTensorSlicePattern, DsaInsertSliceToTensorSlicePattern,
               DsaToTensorToBufferizationPattern, DsaToBufferToBufferizationPattern>(patterns.getContext());
  patterns.add<DsaBinaryOpToLinalgPattern<mlir::dsa::AddOp, arith::AddFOp>,
               ...
               DsaBinaryOpToLinalgPattern<mlir::dsa::DivOp, arith::DivFOp>>(patterns.getContext());
