...
// Retain the former exported ABI while project code uses wafer_memcpy.
void tx81_memcpy(char *srcPtr, char *dstPtr, int *src_shape, int *src_stride,
                 int *dst_shape, int *dst_stride, int rank,
                 uint32_t elem_bytes) {
  wafer_memcpy(srcPtr, dstPtr, src_shape, src_stride, dst_shape, dst_stride,
               rank, elem_bytes);
}

void wafer_memcpy(char *srcPtr, char *dstPtr, int *src_shape, int *src_stride,
                 int *dst_shape, int *dst_stride, int rank,
                 uint32_t elem_bytes) {
  int64_t readIndex = 0;
