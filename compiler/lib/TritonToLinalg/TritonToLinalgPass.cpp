...
#include "dicp/TritonToLinalg/ArgMinMaxConverter.h"
#include "dicp/TritonToLinalg/DescriptorConverter.h"
#include "dicp/TritonToLinalg/FunctionConverter.h"
#include "dicp/TritonToLinalg/HoistBroadcast.h"
#include "dicp/TritonToLinalg/ImplicitPermute.h"
#include "dicp/TritonToLinalg/LoadStoreConverter.h"
#include "dicp/TritonToLinalg/MarkTensorKindPass.h"
#include "dicp/TritonToLinalg/TritonOpConverter.h"
#include "dicp/TritonToLinalg/UseAnalysis.h"
...
static bool isSIMTOp(Operation *op) {
  ...
  return isa<triton::dicp::IndexPutOp, triton::dicp::GatherOutToUbOp,
             triton::dicp::ScatterUbToOutOp, triton::dicp::IndirectLoadOp,
             triton::dicp::IndirectStoreOp>(op);
}
